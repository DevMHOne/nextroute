/**
 * NextRoute Electron Desktop App - Preload Script
 *
...
const MAC_DRAG_STYLE_ID = "nextroute-electron-drag-region-style";
const MAC_DRAG_FALLBACK_ID = "nextroute-electron-drag-region";
const MAC_DRAG_OBSERVER_KEY = "__nextrouteMacDragRegionObserver";
...
function installMacDragRegion() {
  ...
  const attach = () => {
    ...
    style.textContent = `
      header,
      .nextroute-electron-drag-region {
        app-region: drag;
    ...
    dragRegion.className = "nextroute-electron-drag-region";
