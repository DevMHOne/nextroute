...
> **VPS deploy note:** the remote image directory `/usr/lib/node_modules/nextroute/app/`
...
open-sse/                   # @nextroute/open-sse workspace
...
├── comparison/              # NextRoute vs alternatives
