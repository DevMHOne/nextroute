...
// #2939: honor NEXTROUTE_MEMORY_MB (default 512), the same knob
// `nextroute serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.NEXTROUTE_MEMORY_MB);
