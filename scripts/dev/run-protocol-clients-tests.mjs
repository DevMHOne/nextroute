...
const explicitBaseUrl = process.env.NEXTROUTE_BASE_URL || "";
  ...
  const testEnv = {
    ...
    ...(explicitBaseUrl
      ...
      : {
          ...
          NEXTROUTE_BASE_URL: baseUrl,
        }),
    NEXTROUTE_E2E_BOOTSTRAP_MODE: process.env.NEXTROUTE_E2E_BOOTSTRAP_MODE || "open",
  };
