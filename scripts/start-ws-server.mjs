 ...
 *   NEXTROUTE_DISABLE_LIVE_WS — Set to "1" or "true" to disable
 */

if (
  process.env.NEXTROUTE_DISABLE_LIVE_WS === "1" ||
  process.env.NEXTROUTE_DISABLE_LIVE_WS === "true"
) {
  console.log("[LiveWS] Disabled via NEXTROUTE_DISABLE_LIVE_WS");
  process.exit(0);
}
