...
/**
 * write-build-sha.mjs — HEAD sentinel guard for NextRoute release builds.
 *
 * Writes NEXTROUTE_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.NEXTROUTE_BUILD_SHA) {
    return process.env.NEXTROUTE_BUILD_SHA.trim();
  }
  try {
