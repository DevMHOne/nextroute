...
const dataDir = process.env.DATA_DIR || path.join(os.homedir(), ".nextroute");
...
if (uninstallAlreadyInProgress) {
  ...
  try {
    execSync("npm uninstall -g nextroute", {
      stdio: "inherit",
      env: {
        ...process.env,
        NEXTROUTE_SKIP_UNINSTALL_HOOK: "1",
      },
    });
    console.log("\n✅ NextRoute has been successfully uninstalled from your system.");
    if (!fullUninstall) {
