...
export function isMcpDescriptionCompressionEnabled(
  ...
  if (isDisabledEnvValue(process.env.NEXTROUTE_MCP_COMPRESS_DESCRIPTIONS)) return false;
  if (isDisabledEnvValue(process.env.NEXTROUTE_MCP_DESCRIPTION_COMPRESSION)) return false;
