...
export const skillTools = {
  nextroute_skills_list: {
    name: "nextroute_skills_list",
  ...
  nextroute_skills_enable: {
    name: "nextroute_skills_enable",
  ...
  nextroute_skills_execute: {
    name: "nextroute_skills_execute",
  ...
  nextroute_skills_executions: {
    name: "nextroute_skills_executions",
