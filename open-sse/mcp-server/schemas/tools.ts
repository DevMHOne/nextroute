/**
 * MCP Tool Schemas — Contracts for all 22 core and advanced NextRoute MCP tools.
 *
 ...
 *
 * Each tool wraps existing NextRoute API endpoints and exposes them through
...
export interface McpToolDefinition<TInput extends z.ZodTypeAny, TOutput extends z.ZodTypeAny> {
  ...
  phase: 1 | 2;
  /** Source endpoints on NextRoute that this tool wraps */
  sourceEndpoints: readonly string[];
}

// ============ Phase 1: Essential Tools (8) ============

// --- Tool 1: nextroute_get_health ---
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "nextroute_get_health",
  description:
    "Returns the current health status of NextRoute including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 3: nextroute_get_combo_metrics ---
...
> = {
  name: "nextroute_get_combo_metrics",
  description:
...
// --- Tool 6: nextroute_route_request ---
...
> = {
  ...
  description:
    "Sends a chat completion request through NextRoute's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: nextroute_list_models_catalog ---
...
> = {
  name: "nextroute_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "nextroute_web_search",
  description:
    "Performs a web search using NextRoute's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
// --- Tool 9: nextroute_simulate_route ---
...
// --- Tool 10: nextroute_set_budget_guard ---
...
> = {
  name: "nextroute_set_budget_guard",
  description:
...
// --- Tool 11: nextroute_set_routing_strategy ---
...
> = {
  name: "nextroute_set_routing_strategy",
  description:
...
// --- Tool 12: nextroute_set_resilience_profile ---
...
> = {
  name: "nextroute_set_resilience_profile",
  description:
...
// --- Tool 14: nextroute_get_provider_metrics ---
...
> = {
  name: "nextroute_get_provider_metrics",
  description:
...
// --- Tool 15: nextroute_best_combo_for_task ---
...
> = {
  name: "nextroute_best_combo_for_task",
  description:
...
// --- Tool 16: nextroute_explain_route ---
...
// --- Tool 17: nextroute_get_session_snapshot ---
...
> = {
  name: "nextroute_get_session_snapshot",
  description:
...
// --- Tool 18: nextroute_db_health_check ---
...
> = {
  name: "nextroute_db_health_check",
  description:
    "Diagnoses NextRoute database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
// --- Tool 19: nextroute_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "nextroute_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into NextRoute. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "nextroute_compression_status",
  description:
...
> = {
  name: "nextroute_compression_configure",
  description:
...
> = {
  name: "nextroute_set_compression_engine",
...
> = {
  name: "nextroute_list_compression_combos",
...
> = {
  name: "nextroute_compression_combo_stats",
...
> = {
  name: "nextroute_oneproxy_rotate",
  description:
...
> = {
  name: "nextroute_agent_skills_list",
  description:
    "List NextRoute agent skills with optional filtering by category (api/cli) or area. Returns skill metadata including id, name, description, endpoints/commands, and URLs.",
...
> = {
  name: "nextroute_agent_skills_get",
  description:
...
// --- nextroute_agent_skills_coverage ---
...
> = {
  name: "nextroute_agent_skills_coverage",
  description:
