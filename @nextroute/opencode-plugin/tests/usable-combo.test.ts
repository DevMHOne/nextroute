 ...
 * `providerId` field — NextRoute's `normalizeComboRecord` folds the provider
...
import { isUsableCombo, type NextRouteRawCombo } from "../src/index.js";
...
function combo(models: NextRouteRawCombo["models"]): NextRouteRawCombo {
