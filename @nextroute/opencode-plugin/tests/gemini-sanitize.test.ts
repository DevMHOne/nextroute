...
import {
  ...
  createNextRouteFetchInterceptor,
...
test("shouldSanitizeForGemini: gemini-cli/gemini-2.5-pro → true (real NextRoute alias)", () => {
...
test("createGeminiSanitizingFetch: composes correctly with createNextRouteFetchInterceptor (Bearer + sanitization)", async () => {
