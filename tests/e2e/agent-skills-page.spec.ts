...
function makeAgentSkills(): AgentSkill[] {
  ...
  for (let i = 0; i < 22; i++) {
    skills.push({
      ...
      rawUrl: `https://raw.githubusercontent.com/example/NextRoute/main/skills/omni-skill-${i}/SKILL.md`,
      githubUrl: `https://github.com/example/NextRoute/blob/main/skills/omni-skill-${i}/SKILL.md`,
    });
  }
  for (let i = 0; i < 20; i++) {
    skills.push({
      ...
      rawUrl: `https://raw.githubusercontent.com/example/NextRoute/main/skills/cli-skill-${i}/SKILL.md`,
      githubUrl: `https://github.com/example/NextRoute/blob/main/skills/cli-skill-${i}/SKILL.md`,
    });
  }
  return skills;
}
