...
function makeSkill(overrides: Partial<AgentSkill> = {}): AgentSkill {
  return {
    ...
    rawUrl: "https://raw.githubusercontent.com/diegosouzapw/NextRoute/refs/heads/main/skills/omni-providers/SKILL.md",
    githubUrl: "https://github.com/diegosouzapw/NextRoute/blob/main/skills/omni-providers/SKILL.md",
    ...overrides,
  };
}
