 ...
 * NEXTROUTE_MEMORY_MB instead of relying only on the image-level NODE_OPTIONS
 ...
 * uses (mirroring `nextroute serve`): NEXTROUTE_MEMORY_MB clamped to [64, 16384],
 * default 512.
 */
...
test("#2939 honors a valid NEXTROUTE_MEMORY_MB (string or number)", () => {
