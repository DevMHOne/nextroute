 ...
 *   npx nextroute reset-password
 *
 * Resets the admin password for NextRoute.
...
async function main() {
  ...
  if (!passwordState.exists) {
    ...
    console.error(`   Make sure NextRoute has been started at least once.`);
  ...
  console.log("   Restart NextRoute for changes to take effect.\n");
}
