...
import { NEXTROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME } from "@nextroute/open-sse/services/webSearchFallback.ts";
...
const BUILTIN_TOOL_ALIASES: Record<string, string> = {
  [NEXTROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME]: "web_search",
};
...
export async function handleToolCallExecution(
  ...
  switch (provider) {
    ...
    case "anthropic": {
      ...
      // blocks untouched, remove the NextRoute-handled tool_use blocks, and expose
