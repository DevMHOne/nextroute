...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'nextroute'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with NextRoute
...
-- Determines whether each provider uses NextRoute's native executor,
