...
declare global {
  var __nextrouteCredentialCache:
    | {
        initialized: boolean;
...
function getCacheState() {
  if (!globalThis.__nextrouteCredentialCache) {
    globalThis.__nextrouteCredentialCache = {
      initialized: false,
      cache: new Map(),
    };
  }
  return globalThis.__nextrouteCredentialCache;
}
