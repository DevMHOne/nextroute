 ...
 *     is set explicitly. The NextRoute LOCAL_ONLY rule is enforced at the
...
declare global {
  var __nextrouteEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__nextrouteEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__nextrouteEmbedWsStarted = true;
