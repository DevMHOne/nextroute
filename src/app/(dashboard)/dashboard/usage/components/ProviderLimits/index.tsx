...
const LS_PURCHASE_FILTER = "nextroute:limits:purchaseFilter";
const LS_STATUS_FILTER = "nextroute:limits:statusFilter";
const LS_ENV_FILTER = "nextroute:limits:envFilter";
