...
import { IMAGE_PROVIDERS } from "@nextroute/open-sse/config/imageRegistry.ts";
import { VIDEO_PROVIDERS } from "@nextroute/open-sse/config/videoRegistry.ts";
import { MUSIC_PROVIDERS } from "@nextroute/open-sse/config/musicRegistry.ts";
import {
...
> = {
  ...
  speech: {
    ...
    placeholder: "Hello! Welcome to NextRoute, your intelligent AI gateway...",
