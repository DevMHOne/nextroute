 ...
 * When enabled, 9Router models appear as `9router/...` in NextRoute's model selection.
 */
"use client";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-text-muted mt-0.5">
            When enabled, discovered models appear in provider selects across NextRoute.
          </p>
        </div>
        <Toggle
