...
export default function CloudAgentsPage() {
  ...
  useEffect(() => {
    try {
      const stored = localStorage.getItem("nextroute-cloud-agents-settings");
  ...
  const updateSetting = (key: keyof typeof settings, value: boolean) => {
    ...
    setSettings(next);
    try {
      localStorage.setItem("nextroute-cloud-agents-settings", JSON.stringify(next));
    } catch {
      // ignore
    }
  };
