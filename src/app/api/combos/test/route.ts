...
import { resolveNestedComboTargets } from "@nextroute/open-sse/services/combo.ts";
    ...
    try {
      res = await fetch(internalUrl, {
        ...
        headers: {
          ...
          // NextRoute's semantic cache or other request reuse layers.
          "X-NextRoute-No-Cache": "true",
          ...(target.connectionId ? { "X-NextRoute-Connection": target.connectionId } : {}),
