...
// Check if NextRoute is configured as OpenAI-compatible provider
const hasNextRouteConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasNextRoute: hasNextRouteConfig(globalState),
...
// POST - Configure Cline to use NextRoute as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_nextroute";
...
// DELETE - Remove NextRoute OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "NextRoute settings removed from Cline",
    });
  } catch (error) {
