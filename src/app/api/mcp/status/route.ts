...
import { getAuditStats, queryAuditEntries } from "@nextroute/open-sse/mcp-server/audit";
import {
  isMcpHeartbeatOnline,
  isProcessAlive,
  readMcpHeartbeat,
  resolveMcpHeartbeatPath,
} from "@nextroute/open-sse/mcp-server/runtimeHeartbeat";
import {
  getMcpHttpStatus,
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const scopesEnforced = process.env.NEXTROUTE_MCP_ENFORCE_SCOPES === "true";
