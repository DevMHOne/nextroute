...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@nextroute/open-sse/services/rateLimitManager"),
      import("@nextroute/open-sse/services/accountFallback"),
      import("@nextroute/open-sse/services/requestDedup.ts"),
      import("@nextroute/open-sse/services/quotaMonitor.ts"),
      import("@nextroute/open-sse/services/sessionManager.ts"),
