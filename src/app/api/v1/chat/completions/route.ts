...
import { initTranslators } from "@nextroute/open-sse/translator/index.ts";
...
export async function POST(request) {
  ...
  // typical chat payloads. Toggle off via NEXTROUTE_LOG_REQUEST_SHAPE=0.
  if (process.env.NEXTROUTE_LOG_REQUEST_SHAPE !== "0") {
