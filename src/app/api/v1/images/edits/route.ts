...
} from "@nextroute/open-sse/handlers/imageGeneration.ts";
import { getProviderCredentials, clearRecoveredProviderState } from "@/sse/services/auth";
import { parseImageModel, getImageProvider } from "@nextroute/open-sse/config/imageRegistry.ts";
 ...
 *    generated through NextRoute — we then have its `{conversationId, parentMessageId}`
