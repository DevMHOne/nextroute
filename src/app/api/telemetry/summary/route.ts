...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@nextroute/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@nextroute/open-sse/services/sessionManager.ts");
