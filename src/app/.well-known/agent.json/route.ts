 ...
 *
 * Serves the NextRoute A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the NextRoute Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "NextRoute AI Gateway",
    description:
