 ...
 *
 * Source of truth for which browser origins may call NextRoute over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-nextroute-connection, x-internal-test, accept";
