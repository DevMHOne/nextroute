...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-nextroute-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-nextroute-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-nextroute-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-nextroute-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-nextroute-auth-scopes";

/** CLI sends this header so the local process can call management APIs without login. */
export const CLI_TOKEN_HEADER = "x-nextroute-cli-token";
 ...
 * token matches this process's NEXTROUTE_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-nextroute-peer-ip";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-nextroute-peer-locality";
