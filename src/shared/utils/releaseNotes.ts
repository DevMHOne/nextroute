...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/diegosouzapw/NextRoute/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/diegosouzapw/NextRoute/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/diegosouzapw/NextRoute/blob/main/CHANGELOG.md";
