...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/DevMHOne/nextroute/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/DevMHOne/nextroute/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/DevMHOne/nextroute/blob/main/CHANGELOG.md";
